...
public class PageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(op.equals("login")) {
			...
			request.setAttribute("titlea", useModify.getWriting_title());
			request.setAttribute("datea", historyInfor[0]);
			request.setAttribute("writera", historyInfor[1]);
			request.setAttribute("contenta", historyInfor[2]);
